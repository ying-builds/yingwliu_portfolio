...
Any feature I added had to feel light, intentional, and aligned with the app's core purpose. If it started to feel performative or too polished, I knew it wasn't the right direction.
</div>
...
{/* Sits in a Wide rather than in the section above, matching the mid-fi board
    it pairs with. The replacement export is landscape where the old one was
    portrait, so the section's 442px column left it unreadable. */}
<Wide>
...
<Wide>
<MockupImage src="/images/case-studies/bereal/midfi-hifi.webp" alt="Mid-fi and hi-fi screens across the feed, RealGif, profile and Memories flows" width="2198" height="514" preframed="true" />
</Wide>
